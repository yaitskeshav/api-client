...
class PlacesDB(models.Model):
    sNoPlace	                = models.CharField( max_length=200,blank=True,null=True)
    nLongitude	                = models.FloatField(blank=True,null=True)
    nLatitude	                = models.FloatField(blank=True,null=True)
    nPositionCentreLongitude	= models.FloatField(blank=True,null=True)
    nPositionCentreLatitude	    = models.FloatField(blank=True,null=True)
    sStatut	                    = models.IntegerField(blank=True,null=True)
    sGenre	                    = models.CharField( max_length=200,blank=True,null=True)
    sType	                    = models.CharField( max_length=200, blank=True,null=True)
